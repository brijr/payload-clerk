  ...
  return (
    <Section className="font-mono text-sm">
      <Container className="space-y-4">
        <h1>
          Payload and Clerk Starter (<a href="https://payloadstarter.dev">payloadstarter.dev</a>)
        </h1>
        <p className="grid gap-1 underline text-primary">
          <a href="https://github.com/brijr/payload-starter">View on GitHub &rarr;</a>
          <a href="https://clerk.com/docs">Read the Clerk Docs &rarr;</a>
        ...
        <p>This starter uses Payload, Clerk, Postgres, Resend, and Vercel Blob.</p>
        <p className="mb-8">
          Created by{' '}
